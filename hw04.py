...
def parse_args():
  """arguments"""
  config = {
    "data_dir": "/data/Voxceleb1/Dataset",
  ...
  while step < total_steps:
    ...
    if (step + 1) % valid_steps == 0:
      ...
      if valid_accuracy > best_accuracy:
        ...
        pbar.write(f"\nStep {step + 1}, model cached. (accuracy={best_accuracy:.4f})")
...
def main(
  ...
  print(f"[Info]: Predicting test data...",flush = True)
  results = [["Id", "Category"]]
